                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="tgl_bayar" type="date" class="form-control @error('tgl_bayar') is-invalid @enderror" 
                                       name="tgl_bayar" value="{{ old('tgl_bayar', $pembayaran->tgl_bayar) }}" required>
                                @error('tgl_bayar')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="tahun_dibayar" type="text" class="form-control @error('tahun_dibayar') is-invalid @enderror" 
                                       name="tahun_dibayar" value="{{ old('tahun_dibayar', $pembayaran->tahun_dibayar) }}" required>
                                @error('tahun_dibayar')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="jumlah_bayar" type="text" class="form-control @error('jumlah_bayar') is-invalid @enderror" 
                                       name="jumlah_bayar" value="{{ old('jumlah_bayar', $pembayaran->jumlah_bayar) }}" required>
                                @error('jumlah_bayar')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
